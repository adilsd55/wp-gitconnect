...
<link href="https://fonts.googleapis.com/css2?family=Oleo+Script:wght@400;700&family=Raleway:wght@300;400;500;600;700&display=swap" rel="stylesheet">
...
#quiz .submit-steps{color:#DCE5EC;font-size:14px;line-height:1.7;padding-left:22px;margin:10px 0}
#quiz .submit-steps li{color:#DCE5EC;margin-bottom:4px}
#quiz .submit-steps strong{color:#fff}
#quiz .submit-steps a,#quiz .naming-box a{color:var(--db-brass-bright);font-weight:600}
#quiz .naming-box{max-width:660px;margin:14px 0 0;padding:14px 18px;background:rgba(255,255,255,.10);border:1px solid rgba(196,154,77,.45);border-radius:10px;color:#DCE5EC;font-size:14px;line-height:1.7}
#quiz .naming-box strong{color:#fff}
#quiz .naming-box code{color:var(--db-brass-bright);font-family:'DM Mono',monospace;font-size:13px;word-break:break-word}
</style>
<style>
/* ===== WINNING CREATIVES · GOOGLE CHAT LINK CARD ===== */
#creatives .creatives-link-card{border:2px dashed rgba(196,154,77,.6);border-radius:12px;padding:18px 20px;margin:14px 0;display:flex;flex-wrap:wrap;align-items:center;gap:10px;background:#fff}
#creatives .creatives-link-card p{flex-basis:100%;margin:0}
#creatives .creatives-link{display:inline-block;background:#fff;border:2px solid var(--db-link);border-radius:10px;padding:9px 16px;font-weight:700;color:var(--db-link);text-decoration:underline}
#creatives .creatives-link:hover{background:#EEF4FF;opacity:1}
</style>
<style>
/* ===== SOURCE-OF-TRUTH PROVENANCE ===== */
.source-note{background:#EAF2F7;border:1px solid #2A709E;border-left:4px solid #2A709E;border-radius:8px;padding:12px 16px;margin:14px 0;font-size:13px;line-height:1.6;color:#20394B}
.source-note strong{color:#163E5B}
.source-note code{font-family:'DM Mono',monospace;font-size:12px;background:rgba(42,112,158,.14);padding:1px 5px;border-radius:3px}
.op-note{background:#F5F5F2;border:1px dashed #A9AFB5;border-radius:8px;padding:11px 15px;margin:12px 0;font-size:12.5px;line-height:1.55;color:#4F5761}
.op-note strong{color:#163E5B}
.db-sw{border-radius:10px;overflow:hidden;border:1px solid rgba(22,62,91,.14);background:#fff}
.db-sw .bar{height:78px}
.db-sw .meta{padding:9px 12px;font-size:12px}
.db-sw .nm{font-weight:700;color:#163E5B}
.db-sw .hx{font-family:'DM Mono',monospace;color:#5A6470;font-size:11.5px}
.db-sw .rl{color:#5A6470;margin-top:3px;font-size:11px}
.betty{display:flex;gap:18px;align-items:flex-start;background:#fff;border:1px solid rgba(42,112,158,.3);border-radius:12px;padding:18px;margin:12px 0;flex-wrap:wrap}
.betty img{max-height:300px;width:auto;flex-shrink:0}
.betty-copy{flex:1;min-width:220px;font-size:13.5px;line-height:1.65}
</style>
<?php bh_favicon_tags(); ?>
</head>
<body>
...
<section id="hero">
  <div class="hero-inner">
    <div class="hero-logo-wrap">
      <img src="data:image/jpeg;base64," alt="Drain Buddy / Drain Strain logo" onerror="this.dataset.failed='1'">
...
<section id="mission">
  <div class="card collapsible" data-section="mission">
    ...
    <div class="section-body">
      ...
      <h3>Vision <span style="font-size:11px;font-family:'DM Mono',monospace;color:#5A6470;text-transform:uppercase;letter-spacing:.06em">· operational</span></h3>
      <div class="op-note">
        <strong>Not in the brand guideline.</strong> The 2022 guideline defines an About Us line and a Mission, but no Vision and no pillars. The Vision below and the five pillars further down are hub-authored working structure &mdash; keep using them internally, but don't cite them as approved brand assets.
      </div>
      ...
      <div class="source-note">
        <strong>Source of truth:</strong> <code>Drain Buddy Ultra Flo Brand Guidelines.pptx.pdf</code>, PDF p.3 (PPTX slide 3). This is the approved mission, verbatim. Use it as written.
      </div>
      <blockquote class="brand-quote mission">"To eliminate the stress of clogged drains through disruptive innovative design."</blockquote>
      <p style="font-size:13px;margin-top:10px">The same slide gives the approved <strong>About Us</strong> line: <em>&ldquo;Drain Buddy is a deluxe sink and bathtub drain stopper and hair catcher that requires no installation to prevent drain clogs.&rdquo;</em></p>
      <div class="op-note">
        <strong>Corrected.</strong> The hub previously gave the mission as &ldquo;Replace the cheap mesh hair catcher and the plumber visit with one elegant, finish-matched stopper that catches every hair, drains at full speed, and installs in 30 seconds.&rdquo; That is a strong <em>product proposition</em> and it is still useful &mdash; keep it under positioning or product benefits, as a <strong>Positioning statement</strong> below. It is not the official mission.
      </div>

      <h3>Positioning statement <span style="font-size:11px;font-family:'DM Mono',monospace;color:#5A6470;text-transform:uppercase;letter-spacing:.06em">· operational</span></h3>
      <blockquote class="brand-quote">"Replace the cheap mesh hair catcher and the plumber visit with one elegant, finish-matched stopper that catches every hair, drains at full speed, and installs in 30 seconds."</blockquote>

      <h3>Brand pillars <span style="font-size:11px;font-family:'DM Mono',monospace;color:#5A6470;text-transform:uppercase;letter-spacing:.06em">· operational</span></h3>
...
<section id="voice">
  <div class="card collapsible" data-section="voice">
    ...
    <div class="section-body">
      ...
      <div class="source-note">
        <strong>Source of truth:</strong> <code>Drain Buddy Ultra Flo Brand Guidelines.pptx.pdf</code>, PDF pp.9&ndash;10 (slides 9&ndash;10). The approved tone is <strong>friendly, engaging and positive</strong>. The guideline asks us to treat customers with <strong>respect, empowerment and positivity</strong>, and specifies <em>&ldquo;a hint of lighthearted playfulness and sensibility&rdquo;</em> &mdash; Drain Buddy <em>&ldquo;tastefully empowers &amp; inspires customers on keeping their drains clean, functional and stylish.&rdquo;</em> Tone should be <strong>natural, genuine, friendly and fun, yet authoritative and mindful</strong>.
      </div>
      <div class="op-note">
        <strong>Corrected &mdash; the voice had drifted.</strong> This hub previously described Drain Buddy as sounding like &ldquo;a handy neighbor,&rdquo; and its personality list said &ldquo;no forced humor, no winks.&rdquo; That is flatter and more guarded than the approved tone, which explicitly asks for <strong>lighthearted playfulness</strong> and <strong>fun</strong>. Restraint about gross-out imagery is still right &mdash; but that's a content rule, not a reason to strip the warmth and play out of the voice.
      </div>

      <p>Drain Buddy sounds <strong>friendly, engaging and positive</strong> — practical and plain-spoken, with a hint of lighthearted playfulness. We treat the customer with respect and empowerment: she can do this herself, and we're the ones handing her the easy win. We don't lean on shock-value gross imagery and we don't overpromise. The voice is warm and fun without being silly, authoritative without talking down.</p>

      <h3>Voice, tone &amp; style rules — from the guideline</h3>
      <ul style="line-height:1.85;font-size:14px">
        <li><strong>Write in the active tense.</strong> The active voice is immediate, succinct and more likely to motivate action.</li>
        <li><strong>Use a consistent conversational voice.</strong> We don't talk <em>at</em> customers, we talk <em>to</em> them. We're on the same side as our customers.</li>
        <li><strong>Let the facts speak for themselves.</strong> Don't talk down to the audience. Be compelling, but not excessive.</li>
        <li><strong>When in doubt, leave it out.</strong> If the source material doesn't confirm an important fact, leave it out until it's confirmed — Drain Buddy loses trust if we get it wrong.</li>
        <li><strong>Be real, sincere and authentic.</strong> Provide encouragement. Temper complaints with genuine acknowledgement of the problem, perceived or real, then help solve it.</li>
        <li><strong>Convey genuine interest</strong> in our customers and share their values.</li>
        <li><strong>Write in second person</strong> — the customer's point of view.<br>
          <span style="color:#2C7A7B"><strong>Correct:</strong> &ldquo;Keep your tub drain free of clogs with a stylish Drain Buddy to match your bathroom finish.&rdquo;</span><br>
          <span style="color:#B8391F"><strong>Incorrect:</strong> &ldquo;Here is a way people keep their tub drains clog free.&rdquo;</span></li>
        <li><strong>Avoid provocative or suggestive language</strong> in favor of down-to-earth conversational language.</li>
        <li><strong>Mechanics:</strong> don't repeat words in the same paragraph, page or ad; stick to one- and two-syllable words; only use &ldquo;-ings&rdquo; when necessary; use contractions like <em>you're</em> and <em>it's</em>; prefer simple, easy-to-understand words.</li>
      </ul>
  ...
  <div class="card collapsible" data-section="personality">
    ...
    <div class="section-body">
      ...
      <div class="adj-grid">
        ...
        <div class="adj"><div class="adj-word">Friendly</div><div class="adj-desc">Warm and approachable, with the hint of lighthearted playfulness the guideline asks for. Fun, but never silly or at the customer's expense.</div></div>
...
<section id="visual">
  <div class="card collapsible" data-section="visual">
    ...
    <div class="section-body">
      ...
      <h3>Color palette</h3>
      <div class="source-note">
        <strong>Source of truth:</strong> <code>Drain Buddy Ultra Flo Brand Guidelines.pptx.pdf</code>, PDF p.7 (slide 7). The guideline is explicit: <strong>two primary logo colors and three accent colors</strong> &mdash; five in total, named and hex-specified below. The nine-color hydro/cream/brass set this hub previously listed (#0E5379, #07334D, #176B98, #2BB3D9, #E8F0F4, #F5EFE0, #C49A4D, #2C7A7B, #1F2937) does <strong>not appear in the source</strong> and was never approved. There is no brass, no cream and no cyan in this brand.
      </div>
      <p style="font-size:12.5px;font-family:'DM Mono',monospace;letter-spacing:.1em;text-transform:uppercase;color:#5A6470;margin:14px 0 6px">Primary logo colors</p>
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:12px">
        <div class="db-sw"><div class="bar" style="background:#163E5B"></div><div class="meta"><div class="nm">Midnight Blue</div><div class="hx">#163E5B</div><div class="rl">Primary logo color</div></div></div>
        <div class="db-sw"><div class="bar" style="background:#2A709E"></div><div class="meta"><div class="nm">Teal Blue</div><div class="hx">#2A709E</div><div class="rl">Primary logo color</div></div></div>
      </div>
      <p style="font-size:12.5px;font-family:'DM Mono',monospace;letter-spacing:.1em;text-transform:uppercase;color:#5A6470;margin:16px 0 6px">Accent colors</p>
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:12px">
        <div class="db-sw"><div class="bar" style="background:#D8E7EF"></div><div class="meta"><div class="nm">Pale Steam</div><div class="hx">#D8E7EF</div><div class="rl">Accent &mdash; signature brand color, approved logo background</div></div></div>
        <div class="db-sw"><div class="bar" style="background:#2B7DB9"></div><div class="meta"><div class="nm">Vibrant Blue</div><div class="hx">#2B7DB9</div><div class="rl">Accent</div></div></div>
        <div class="db-sw"><div class="bar" style="background:#94AFC1"></div><div class="meta"><div class="nm">Mist</div><div class="hx">#94AFC1</div><div class="rl">Accent</div></div></div>
      </div>

      <div class="team-callout creative">
        <span class="team-tag">🎨 Creative · Working with five colors</span>
        <p>The guideline separates the palette by job: <strong>Midnight Blue and Teal Blue are the logo colors</strong>, and <strong>Pale Steam, Vibrant Blue and Mist are accents that "provide additional dimension."</strong> Build layouts from that split &mdash; a blue-led composition with Pale Steam or Mist carrying the light areas. <strong>Pale Steam is also the only brand color the logo may sit on</strong> besides white (see Logo).</p>
        <p style="margin-top:8px"><strong>Retired:</strong> the previous 60-30-10 rule and the "Brass for premium-feel callouts" guidance were built on the unapproved palette. Brass is not a Drain Buddy color. Any new ratio or use-case convention must be rebuilt from these five and confirmed by the Brand Lead.</p>
      </div>

      <div class="team-callout brand">
        <span class="team-tag">🌿 Brand · Colors are named, so use the names</span>
        <p>The guideline names all five colors. Use those names in briefs and specs &mdash; <strong>Midnight Blue, Teal Blue, Pale Steam, Vibrant Blue, Mist</strong> &mdash; rather than inventing labels like "Hydro Blue" or "Splash Cyan", which is how the previous palette drifted away from the source in the first place.</p>
      </div>

      <h3>Typography</h3>
      <div class="source-note">
        <strong>Source of truth:</strong> <code>Drain Buddy Ultra Flo Brand Guidelines.pptx.pdf</code>, PDF p.8 (slide 8). The guideline states the brand "leverages two typefaces: one for headers &amp; accents, and one for body text" &mdash; <strong>Oleo Script for headings and accents, Raleway for body text</strong>. It also notes Oleo Script is a Google Font, so both are freely available and there is no licensing obstacle. The four-family stack this hub previously listed (Bebas Neue, Fraunces, Inter, DM Mono) is the shared hub template and was never approved for Drain Buddy.
      </div>

      <table>
        <thead><tr><th>Family</th><th>Role per the guideline</th><th>Use for</th></tr></thead>
        <tbody>
          <tr><td><strong>Oleo Script</strong></td><td>Headings &amp; accents</td><td>Section heads, headlines, accent lines, callout titles</td></tr>
          <tr><td><strong>Raleway</strong></td><td>Body text</td><td>Paragraphs, product copy, UI, captions, CX templates</td></tr>
        </tbody>
      </table>

      <div class="type-sample" style="background:#fff;border:1px solid rgba(42,112,158,.28);border-radius:10px;padding:18px;margin:12px 0">
        <div style="font-family:'Oleo Script',cursive;font-size:2rem;color:#163E5B;line-height:1.2">Keep your drain clog free</div>
        <div style="font-family:'Raleway',sans-serif;font-size:14.5px;color:#3F4C5C;margin-top:10px;line-height:1.65">A deluxe sink and bathtub drain stopper and hair catcher that requires no installation to prevent drain clogs. Drops in, twists to lock, and pops out for cleaning.</div>
      </div>

      <div class="team-callout creative">
        <span class="team-tag">🎨 Creative · Two families, two jobs</span>
        <p>Oleo Script is a script face with a lot of character &mdash; it pairs naturally with the scripted logo and should carry <strong>headings and accents only</strong>. Never set body copy or long paragraphs in it. Raleway does everything else. There is no approved display sans, no serif and no monospace in this brand, so spec labels and eyebrows belong in Raleway, not a mono face.</p>
      </div>

      <h3>Logo</h3>
      <div class="source-note">
        <strong>Source of truth:</strong> <code>Drain Buddy Ultra Flo Brand Guidelines.pptx.pdf</code>, PDF pp.4&ndash;5 (slides 4&ndash;5). The guideline describes the mark precisely: <em>&ldquo;a simple scripted soft-curved version of our name, Drain Buddy. It features blue font with a slightly darker right-side shadow over a white background.&rdquo;</em>
      </div>
      <div style="background:#fff;border:1px solid rgba(42,112,158,.3);border-radius:10px;padding:18px;margin:12px 0;text-align:center">
        <img src="data:image/jpeg;base64," alt="Drain Buddy scripted wordmark in blue with a darker right-side shadow" style="max-width:100%;width:auto;max-height:190px;height:auto">
        <div style="font-family:'DM Mono',monospace;font-size:10px;letter-spacing:.1em;text-transform:uppercase;color:#5A6470;margin-top:10px">Guideline p.4 &mdash; reference only, not a production asset</div>
      </div>

      <h4>Approved rules, verbatim from slide 5</h4>
      <ul style="line-height:1.8;font-size:14px">
        <li>Use the logo <strong>coloured in the correct brand shades</strong> provided, <strong>or in the approved all-black style</strong>.</li>
        <li><strong>Do not stretch</strong> the logo out of the correct proportion.</li>
        <li><strong>Only use the logo placed on white or on Pale Steam</strong> (<code>#D8E7EF</code>), the signature brand color.</li>
      </ul>
      <div class="op-note">
        <strong>Corrected &mdash; background rules were wrong.</strong> The hub previously permitted the logo on "Cream, Mist, or white" with a reversed white version "on Hydro Blue or Slate". Cream, Hydro Blue and Slate are not brand colors, and the guideline restricts backgrounds to <strong>white or Pale Steam only</strong>. Mist (<code>#94AFC1</code>) is a real brand color but is <em>not</em> an approved logo background. If you need the mark on a dark surface, use the approved all-black style on an approved ground rather than inventing a reversed treatment.
      </div>
      <div class="op-note">
        <strong>Not specified:</strong> clear space and minimum size are absent from the 2022 guideline. Treat any figure this hub or a brief gives as operational and route it through the Brand Lead before publishing it as a standard.
      </div>

      <h3 style="margin-top:26px">Character Logo &mdash; Drain Betty</h3>
      <div class="source-note">
        <strong>Source of truth:</strong> <code>Drain Buddy Ultra Flo Brand Guidelines.pptx.pdf</code>, PDF p.6 (slide 6). The guideline defines a <strong>character logo</strong> that this hub was missing entirely. It is a named brand asset, not decoration.
      </div>
      <div class="betty">
        <img src="data:image/jpeg;base64," alt="Drain Betty character illustration: a DIYer in overalls and a red headscarf holding a wrench">
        <div class="betty-copy">
          <p style="margin:0 0 8px"><strong>Meet Drain Betty.</strong> Per the guideline: &ldquo;Drain Betty is a down-to-earth DIYer who empowers customers to make sure their bathroom drains are clog free by dropping in a Drain Buddy. She is friendly &amp; stylish yet relatable.&rdquo;</p>
          <p style="margin:0 0 8px"><strong>Why she matters.</strong> Betty is the human face of the brand's empowerment message &mdash; the customer doesn't need a plumber, she needs Betty's confidence. She maps directly onto the guideline's tone of voice (friendly, engaging, positive, lightly playful) and onto the approved audience, which is women 35&ndash;54 who are style-and-function focused.</p>
          <p style="margin:0"><strong>Use.</strong> The guideline shows Betty in two variants, labelled <strong>Drain Buddy</strong> and <strong>Drain Strain</strong> &mdash; one per brand. Request approved artwork from the Brand Lead before using her in any campaign.</p>
        </div>
      </div>
      <div class="op-note">
        <strong>Open action.</strong> The guideline does not give Betty usage rules, sizing or approved poses beyond the two variants shown. Either get a Character Logo standard written, or formally retire her in a revised guideline &mdash; leaving an approved brand asset undocumented is how she went missing from this hub in the first place.
      </div>

      <h3 style="margin-top:26px">Wordmark usage notes <span style="font-size:11px;font-family:'DM Mono',monospace;color:#5A6470;text-transform:uppercase;letter-spacing:.06em">· operational</span></h3>
      ...
      <div class="logo-blocks">
        <div>
          <div class="logo-block" style="background:#FFFFFF;border:1px solid rgba(22,62,91,.18);display:flex;align-items:center;justify-content:center;padding:22px;border-radius:10px;min-height:120px">
            <span style="font-family:'Oleo Script',cursive;font-size:2.2rem;color:#2A709E;text-shadow:2px 2px 0 #163E5B;line-height:1.1">Drain Buddy</span>
          </div>
          <div class="logo-caption">Approved ground 1 &mdash; white</div>
        </div>
        <div>
          <div class="logo-block" style="background:#D8E7EF;border:1px solid rgba(22,62,91,.18);display:flex;align-items:center;justify-content:center;padding:22px;border-radius:10px;min-height:120px">
            <span style="font-family:'Oleo Script',cursive;font-size:2.2rem;color:#2A709E;text-shadow:2px 2px 0 #163E5B;line-height:1.1">Drain Buddy</span>
          </div>
          <div class="logo-caption">Approved ground 2 &mdash; Pale Steam #D8E7EF</div>
        </div>
      </div>
      <div class="op-note">
        <strong>These two panels show the only approved logo grounds</strong> &mdash; white and Pale Steam &mdash; per guideline slide 5. The lettering here is an <em>approximation</em> set in Oleo Script to indicate placement and the darker right-side shadow; it is not the logo. Use the real artwork from the brand folder, and see the reference image above for the actual letterforms.
      </div>
      <div class="op-note">
        <strong>Removed:</strong> this hub previously showed two panels captioned &ldquo;Primary &middot; use on light surfaces&rdquo; and &ldquo;Reversed &middot; use on dark surfaces&rdquo;, both hot-linking the same image from <code>drainstrain.com</code>. The reversed-on-dark treatment isn't approved, the two panels showed an identical file, and hot-linking another domain's CDN is not an asset-management practice we should model.
      </div>
      ...
      <div class="source-note">
        <strong>Source of truth:</strong> <code>Drain Buddy Ultra Flo Brand Guidelines.pptx.pdf</code>, PDF p.11 (slide 11). The guideline's photography is <strong>&ldquo;beautiful, authentic, and inspiring yet relatable.&rdquo;</strong>
        <p style="margin:8px 0 0"><strong>Visual tone:</strong> bright, fresh natural lighting preferred; hints of nature and the brand color palette as accents when integrating color; neutral, earth-toned warm grey tones to complement the product finishes.</p>
        <p style="margin:8px 0 0"><strong>Integrate:</strong> clean, picturesque but <em>&ldquo;lived in&rdquo;</em> bathrooms, sinks and tubs; <strong>people &amp; pets in real-life &ldquo;get clean&rdquo; moments</strong>; silo product shots on white or light neutral grounds; and <strong>water with movement</strong> that complements the brand palette.</p>
      </div>
      <div class="op-note">
        <strong>Corrected &mdash; three approved subjects were missing.</strong> This hub's direction was bathroom-only and had no place for <strong>pets</strong>, <strong>moving water</strong>, or <strong>hints of nature</strong>, all of which the guideline calls for. It also listed white-background silo shots as a near-don't ("never for paid social") when the guideline names them as something we <em>seamlessly integrate</em>. Those have been added and corrected below. Note that pet owners are also an approved audience segment (p.13), so pets in frame do double duty.
      </div>
      <div class="do-dont">
        <div class="do">
          <h4>Do shoot</h4>
          <ul>
            ...
            <li>Real reno-grade bathrooms (renters and homeowners), not magazine showrooms — clean and picturesque, but visibly <strong>&ldquo;lived in&rdquo;</strong></li>
            <li><strong>People &amp; pets in real-life &ldquo;get clean&rdquo; moments</strong> — a dog after a bath, a kid at the sink. An approved subject the hub was missing.</li>
            <li><strong>Water with movement</strong> — running taps, draining water, splash — shot so it complements the brand blues</li>
            <li><strong>Silo product shots</strong> on white or light neutral-tone backgrounds — explicitly approved, not just a PDP fallback</li>
            <li><strong>Hints of nature</strong> and brand-palette accents; neutral, earth-toned warm greys to complement the product finishes</li>
          </ul>
        </div>
        <div class="dont">
          <h4>Don't shoot</h4>
          <ul>
            ...
            <li>Flat, dim or heavily artificial lighting — the guideline prefers bright, fresh, natural light</li>
...
<section id="audience">
  <div class="card collapsible" data-section="audience">
    ...
    <div class="section-body">
      ...
      <div class="source-note">
        <strong>Source of truth:</strong> <code>Drain Buddy Ultra Flo Brand Guidelines.pptx.pdf</code>, PDF pp.12&ndash;13 (slides 12&ndash;13). The approved target audience is specific:
        <ul style="margin:8px 0 0;line-height:1.8">
          <li><strong>Women 35&ndash;54</strong></li>
          <li><strong>Top states:</strong> WA, CA, NY, TX</li>
          <li><strong>Pet owners</strong></li>
          <li><strong>Wear jewelry</strong></li>
          <li><strong>Style &amp; function focused</strong></li>
        </ul>
      </div>
      <div class="op-note">
        <strong>Corrected.</strong> This hub previously broadened the core to &ldquo;adult homeowner or renter between roughly 28 and 65&rdquo;, which erased every distinguishing signal in the approved profile &mdash; the gender skew, the age band, the state concentration, and the jewelry and pet-ownership markers that actually drive targeting. The approved profile above is now the primary definition. If newer research supersedes it, <strong>label that research with its date and source</strong> before it replaces the guideline.
      </div>

      <h4 style="margin-top:20px">Suggested audiences &mdash; the guideline's five segments</h4>
      <p style="font-size:13px;color:#5A6470;margin-top:4px">Slide 13 breaks the audience into five targetable groups with their own signals. These are the approved starting point for paid segmentation.</p>
      <table>
        <thead><tr><th>Segment</th><th>Age</th><th>Signals</th></tr></thead>
        <tbody>
          <tr><td><strong>Moms</strong></td><td>35&ndash;54</td><td>Style focused · wear jewelry · have kids</td></tr>
          <tr><td><strong>Single women</strong></td><td>25&ndash;54</td><td>Style focused · wear jewelry · shopping enthusiast</td></tr>
          <tr><td><strong>Husbands</strong></td><td>35&ndash;54</td><td>Have beards · DIYers · married with daughters · middle class</td></tr>
          <tr><td><strong>Pet owners</strong></td><td>22&ndash;54</td><td>Dog owners · cat owners · low-to-middle class</td></tr>
          <tr><td><strong>Homeowners</strong></td><td>29&ndash;54</td><td>New movers · DIYers · middle class</td></tr>
        </tbody>
      </table>

      <div class="team-callout marketing">
        <span class="team-tag">📢 Marketing · Platform strategy, per the guideline</span>
        <p>Slide 14 is explicit that social advertising varies by platform and each needs its own strategy: <strong>Instagram</strong> &mdash; beautiful, music, thoughtful layout. <strong>TikTok</strong> &mdash; UGC, viral sounds and trends, less polished. Branding on social is organic and Drain Buddy owns the pages and accounts; paid can run as promoted/boosted posts, creator collaborations, or purpose-built ad units.</p>
      </div>

      <h4 style="margin-top:20px">B2B / wholesale <span style="font-size:11px;font-family:'DM Mono',monospace;color:#5A6470;text-transform:uppercase;letter-spacing:.06em">· operational</span></h4>
      <p>The B2B/wholesale customer is a <strong>property manager, hospitality buyer, multi-family operator, or independent hardware-store owner</strong> looking for a low-cost preventive fix that reduces plumber callouts on units and rooms they manage. This segment is not in the 2022 guideline &mdash; it's a hub-authored operational profile.</p>

      <h3>Customer personas <span style="font-size:11px;font-family:'DM Mono',monospace;color:#5A6470;text-transform:uppercase;letter-spacing:.06em">· operational</span></h3>
      <div class="op-note">
        <strong>Operational, not brand-approved.</strong> The personas below are hub-authored tools for briefing and ad targeting. Keep using them &mdash; but the guideline's five suggested audiences above are the approved segmentation, and where the two disagree, the guideline wins.
      </div>
  ...
  <div class="card collapsible" data-section="quiz">
    ...
    <div class="section-body">
      ...
      <div id="quiz-intro">
        ...
        <p style="color:#DCE5EC;font-size:14px;max-width:660px">Read everything above first. You'll get a multiple-choice question one at a time, drawn from the whole hub. Select an answer and you'll see immediately whether you got it right, then click Next to continue. <strong style="color:#fff">Pass: 21 of 30 correct (70%).</strong> Retake as many times as you need — no penalty.</p>
        <p style="color:#DCE5EC;font-size:14px;max-width:660px">When you pass, enter your name and title, then capture your result — a <strong style="color:#fff">screenshot of your score card is the easiest option</strong>, or you can print or save the certificate. <strong style="color:#fff">Every quiz — this one and every brand or platform quiz — follows the same submission process:</strong></p>
        ...
        <div class="naming-box">
          ...
          <span style="font-size:13px">Example for this hub: <code>Jane Doe_CX_DrainBuddy_Quiz_092026.pdf</code></span>
        </div>
...
const SEARCH_INDEX = [
  ...
  {id:'visual', title:'06 · Visual Identity', group:'Foundation', keywords:'visual identity color palette midnight blue teal blue pale steam vibrant blue mist typography oleo script raleway logo character logo drain betty photography'},
...
const QUIZ_QUESTIONS = [
  ...
  {
    q: "A Drain Buddy ad pairs the founder's Shark Tank moment with current Home Depot, Ace, and Walmart shelf presence. Which universal pattern is doing the work?",
    options: [
    ...
    correct: 0,
    rationale: "Pairing the Shark Tank moment with current retail presence is straight social proof — it shows the customer that others already trust the brand instead of asking them to take the brand's word for it."
  },
...
function renderResult(){
  ...
  if(passed){
    ...
    html += '<img src="data:image/jpeg;base64," alt="Drain Buddy logo" style="max-width:140px;max-height:50px;margin:4px auto 14px;display:block" onerror="this.style.display=\'none\'">';
