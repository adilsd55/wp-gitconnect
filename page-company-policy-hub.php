...
<aside id="toc-drawer" class="">
  ...
  <nav id="toc-drawer-nav">
    ...
    <a href="#pmtool"><span class="toc-drawer-num">18</span><span class="toc-drawer-label">YAS - The InvenTel PM Tool</span></a>
  ...
  <div class="card collapsible">
    ...
    <div class="section-body">
      ...
      <div class="toc-grid">
        ...
        <a class="toc-tile" href="#pmtool"><span class="toc-tile-num">18</span><span class="toc-tile-label">YAS - The InvenTel PM Tool</span></a>
  ...
  <div class="card collapsible">
    ...
    <div class="section-body">
      ...
      <div class="team-callout newhire" id="callout-0">
        ...
        <p><strong>Your first-week path:</strong> (1) Read this hub top to bottom. (2) Work through the <a href="#checklist">New-Hire Setup Checklist</a> — 2FA, time zone, banking, YAS, camera test. (3) Take the <a href="#quiz-section">Knowledge Check Quiz</a> at the bottom, then follow the standard submission process — upload your result to the Quiz Results folder and notify the person who assigned it (for onboarding, that's the Performance Team). (4) Ask your Team Lead anything the hub doesn't answer.</p>
      </div>
    ...
    <div class="section-body">
      ...
      <div class="do-dont">
        ...
        <div class="do" style="background:rgba(200,32,42,.06);border-color:var(--iv-signal)">
          ...
          <ul>
            <li><strong>Daily standup</strong> — submitted in the YAS (Daily Scrum), no longer a Drive sheet</li>
            <li><strong>Leave requests</strong> — submitted in the YAS (Leave Management), no longer a Drive form</li>
...
<section id="leave">
  <div class="card collapsible">
    ...
    <div class="section-body">
      <p>Your total annual paid leave allowance is <strong>16 days</strong>, made up of three buckets. Everything beyond 16 days in a year is unpaid. Days can be combined and taken as half-days, and your <strong>balance is tracked in the YAS.</strong></p>
      ...
      <div class="hazard" id="hazard-4">
        <div class="hazard-bar"></div>
        <div class="hazard-body">
          <h4>📋 All leave is requested in the YAS — effective immediately</h4>
          <p>Leave is <strong>no longer a Google Form</strong>. Every leave request now goes through <strong>Leave Management inside the YAS</strong>&nbsp;(see <a href="#pmtool">YAS - The InvenTel PM Tool</a>). Requests submitted any other way may not be considered. Your <strong>balances</strong> are updated in the tool too.</p>
        </div>
      </div>

      <h3 style="margin-top:20px">How to submit a leave request</h3>
      <div class="flow">
        <div class="flow-step"><div class="flow-step-body">Log in to your <strong>YAS</strong> account.</div></div>
      ...
      <p>Submitting isn't approval. The YAS notifies the <strong>HR leave team member (Workforce Analyst Team)</strong>, who reviews your request and either approves or denies it. A few things shape what happens next:</p>
      <div class="flow">
      ...
      <div class="hazard" id="hazard-6">
        ...
        <div class="hazard-body">
          ...
          <p>InvenTel observes <strong>zero company holidays</strong>. No date is automatically off — not New Year's Eve or Day, and <strong>not US holidays either.</strong> A US public holiday is a normal working day here unless you have personally requested and been approved for it. The same is true for holidays in your own country: they are not days off by default. <strong>If you want a day off for any holiday — US, local, religious, or personal — you must request it in the YAS and wait for written approval.</strong> Assuming a day is off and not showing up is treated as an unapproved absence.</p>
        </div>
      </div>
      <p>Every holiday is a <strong>floating</strong> day: you choose which dates are meaningful to you, then request them. Submit those requests in the YAS as soon as you know your dates (honoring the same notice windows above) rather than waiting until the date is close — the earlier you ask, the more likely it's approved without conflict.</p>
  ...
  <div class="card collapsible">
    <div class="section-header-bar" onclick="toggleSection(this)">
      <div class="section-header-left">
        ...
        <h2>YAS - The InvenTel PM Tool</h2>
      </div>
      <button class="section-toggle" aria-label="Toggle section"><svg viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg></button>
    </div>
    <div class="section-body">
      ...
      <div class="team-callout newhire" id="callout-14">
        ...
        <p></p><h4 data-start="609" data-end="641" class="PDq2pG_selectionAnchorContainer"><span aria-hidden="true" class="PDq2pG_selectionAnchor"></span></h4>&nbsp;Sign in to the YAS:&nbsp;<a href="https://inventelpm.automindlabinventel.com/" target="_blank" rel="noopener" style="color: rgb(176, 24, 32);">inventelpm.automindlabinventel.com</a>&nbsp;using <strong data-start="672" data-end="690" style="color: rgb(26, 20, 22);">Google Sign-In&nbsp;</strong>with your InvenTel company email (<code data-start="725" data-end="740">@inventel.net</code>) or another approved company domain. Your account will be created automatically the first time you sign in.<p data-start="850" data-end="1015"></p>The <strong>Performance Team</strong> will help you get set up and make sure your <strong>department and role are assigned correctly</strong>. Complete the platform walkthroughs below, and ask the Performance Team if anything looks off.<p></p>
      </div>

      <h3 style="margin-top:22px">Platform walkthroughs</h3>
      <p>Watch these short walkthroughs to learn your way around the YAS:</p>
      <div class="mini-grid">
        <div class="mini"><div class="mini-k">Walkthrough · Part 1</div><div class="mini-v"><a href="https://www.loom.com/share/c4f411b04a6b4f31add24bd085518558" target="_blank" rel="noopener">YAS walkthrough (Loom)</a></div></div>
        <div class="mini"><div class="mini-k">Walkthrough · Part 2</div><div class="mini-v"><a href="https://www.loom.com/share/beeb60c83ce6437ab6014b22bbb3895d" target="_blank" rel="noopener">YAS walkthrough (Loom)</a></div></div>
      </div>
      <div class="team-callout newhire" id="callout-15">
        <span class="team-tag">YAS Dashboard Resource Hub</span>
        <p>The <a href="https://drive.google.com/drive/folders/1ST2jUR54nmCynkkL_eNRp6SyP4B2JUVU?usp=drive_link" target="_blank" rel="noopener"><strong>YAS Dashboard folder</strong></a> holds the full Walkthrough Library and the Errors Sheet in one place. Found a bug or have feedback on the tool? Log it in the <a href="https://docs.google.com/spreadsheets/d/136ZCsJ3UROX090frY3JDfaGEs_QyDSGlFaef_AxqSUY/edit?usp=drive_link" target="_blank" rel="noopener"><strong>YAS — Bugs &amp; Errors Sheet</strong></a>.</p>
      </div>

      <h3 style="margin-top:20px">What you'll use it for</h3>
      <div class="feature-grid">
        <div class="feature-tile"><span class="feature-tile-icon">📋</span><h4>Daily Scrum</h4><p>Your standup every workday — active tasks, status (In-Progress / Completed / Blocked), and any blockers.<a href="https://inventelpm.automindlabinventel.com/scrum" target="_blank" rel="noopener"> YAS Daily Scrum</a></p><div><br></div><p></p></div>
        <div class="feature-tile"><span class="feature-tile-icon">⏱️</span><h4>Time Tracker</h4><p>Per-task timer (Est vs Logged). Start it on the task you're working, stop when done. check the:&nbsp;<a href="https://drive.google.com/file/d/1TKmNfBr12UqMDapY5vU8CVNQKh5drlWr/view?usp=sharing" target="_blank" rel="noopener">InvenTel Time Tracker Video Guide</a></p></div>
        ...
        <div class="feature-tile"><span class="feature-tile-icon">📊</span><h4>Tasks &amp; Projects</h4><p>Your assigned work, projects, channels, and dashboards — the hub for everything you do.<a href="https://inventelpm.automindlabinventel.com/tasks" target="_blank" rel="noopener">My Tasks</a></p><div><br></div><div><br></div><p></p></div>
      </div>
...
<p data-start="2485" data-end="2579">Using the time tracker is <strong>mandatory</strong>. The <strong data-start="2489" data-end="2539">Time Tracker is a separate desktop application</strong> and is not part of the YAS web app.</p>
...
<p data-start="3057" data-end="3149"></p>Some team members have <em>not</em> been activating the tracker per task and later reported missing or inaccurate time logs. To avoid this, it's <strong>your responsibility</strong> to make sure the tracker is running correctly at all times while you work. Make sure you've installed the tracker and are actively using it. Please also review the <a href="https://www.loom.com/share/c4f411b04a6b4f31add24bd085518558" target="_blank" rel="noopener">Time-Tracker Training video</a> and follow it carefully.</div><p></p>
      ...
      <div class="team-callout finance" id="callout-16">
        ...
        <p>A <strong>notifications</strong> feature rolled out with the latest version of the YAS. If your notifications aren't working, <strong>uninstall the old app and download the latest version.</strong> Make sure it's installed and that you're actively using it while working. If you hit <strong>any</strong> issue with installation, login, setup, or usage, contact the <strong>Workforce Analyst Team</strong> right away so they can help you get it resolved.</p>
      </div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ...
            <tr><td><strong>YAS Dashboard &amp; company processes</strong></td><td>Repeated failure to update tasks in the <a href="#pmtool">YAS Dashboard</a>; failure to follow the required ticket structure or workflows; failure to submit leave requests through the YAS; failure to accurately use the Time Tracker after coaching.</td></tr>
  ...
  <div class="card collapsible">
    ...
    <div class="section-body">
      <dl class="glossary">
        ...
        <dt id="gloss-2">Leave Management</dt><dd>The area inside the InvenTel YAS where all leave — planned and emergency/day-of — is requested, and where your leave balances are tracked. It replaced the old Google Leave Form.</dd>
        <dt id="gloss-3">Drive HR Resources Folder</dt><dd>The shared Drive folder holding all key forms and reference material — the Onboarding Deck &amp; FAQs, Team Structures, and Invoice Template. (Leave is now requested in the YAS, not here.)</dd>
        ...
        <dt id="gloss-9">Floating Holiday</dt><dd>A holiday day you choose for yourself rather than a fixed company-observed date. InvenTel has no mandatory holidays; all are floating and requested in the YAS.</dd>
        <dt id="gloss-10">Incomplete Workday</dt><dd>A deviation from standard hours (late start, early finish, or a lunch over one hour). Documented the same day in the YAS's Leave Management, with the exact ET time.</dd>
        ...
        <dt id="gloss-12">Daily Scrum / Standup</dt><dd>Your everyday update in the YAS's Daily Scrum — active tasks, status, and blockers. Required every workday.</dd>
        <dt id="gloss-13">InvenTel YAS Dashboard</dt><dd>InvenTel's in-house project-management platform (its own ClickUp) — the single source of truth for tasks, the daily scrum, the time tracker, leave requests and balances, channels, and dashboards.</dd>
        <dt id="gloss-14">Time Tracker</dt><dd>The per-task timer inside the YAS, with periodic screenshots. Turning it on for every task is mandatory; pause it for breaks; deleting a screenshot also deletes the linked time.</dd>
...
<section id="faq">
  <div class="card collapsible">
    ...
    <div class="section-body">
      ...
      <div class="faq-item"><p class="faq-q" id="faq-q-5">How much notice do I need to request time off?</p><p class="faq-a">7 days for 1 day, 14 days for 2 consecutive days, 21 days for 3 or more. Submit in the YAS (Leave Management); approval or denial comes within 24 hours. Don't assume approval until it's in writing.</p></div>
  ...
  <div class="card collapsible">
    ...
    <div class="section-body">
      ...
      <div id="checklist-items">
        ...
        <div class="cl-group">
          <div class="cl-group-title">🛠️ YAS Dashboard, social &amp; team</div>
          <ul class="cl-list">
            <li><button class="cl-item" onclick="toggleCheck(this)"><span class="cl-checkbox"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg></span><span class="cl-item-text">Create your <a href="https://inventelpm.automindlabinventel.com/" target="_blank" rel="noopener">YAS</a> account (the Performance Team helps with setup and assigns your department/role), complete the Loom walkthrough, and confirm the time tracker is installed and running.</span></button></li>
