...
#quiz-section .submit-steps{color:rgba(255,255,255,.90);font-size:14px;line-height:1.7;padding-left:22px;margin:10px 0}
#quiz-section .submit-steps li{color:rgba(255,255,255,.90);margin-bottom:4px}
#quiz-section .submit-steps strong{color:#fff}
#quiz-section .submit-steps a,#quiz-section .naming-box a{color:#FFD98A;font-weight:600}
#quiz-section .naming-box{max-width:660px;margin:14px 0 0;padding:14px 18px;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.40);border-radius:10px;color:rgba(255,255,255,.90);font-size:14px;line-height:1.7}
#quiz-section .naming-box strong{color:#fff}
#quiz-section .naming-box code{color:#FFD98A;font-family:'DM Mono',monospace;font-size:13px;word-break:break-word}
</style>
<style>
/* ===== §12 SAMPLE WINNING CREATIVES ===== */
#creatives .creative-intro{background:var(--al-red-bg);border:1px solid var(--al-border);border-radius:14px;padding:22px 24px;margin:16px 0}
#creatives .creative-intro>strong{display:block;font-size:15px;color:var(--al-text-dk);margin-bottom:12px;line-height:1.5}
#creatives .pattern-list{list-style:none;counter-reset:pat;padding:0;margin:0}
#creatives .pattern-list li{counter-increment:pat;position:relative;padding:0 0 16px 0;font-size:14px;line-height:1.7;color:var(--al-text)}
#creatives .pattern-list li:last-child{padding-bottom:0}
#creatives .pat-title{display:block;font-weight:700;color:var(--al-red);font-size:14.5px;margin-bottom:4px}
#creatives .through-line{background:linear-gradient(135deg,var(--al-red) 0%,var(--al-red-dk) 100%);border-left-color:var(--al-peach)}
#creatives .creatives-link-card{border:2px dashed rgba(204,31,23,.45);border-radius:12px;padding:18px 20px;margin:14px 0;display:flex;flex-wrap:wrap;align-items:center;gap:10px;background:#fff}
#creatives .creatives-link-card p{flex-basis:100%;margin:0}
#creatives .creatives-link{display:inline-block;background:#fff;border:2px solid var(--al-link);border-radius:10px;padding:9px 16px;font-weight:700;color:var(--al-link);text-decoration:underline}
#creatives .creatives-link:hover{background:#EEF4FF;opacity:1}
</style>
<style>
/* ===== SEARCH: active row + target flash ===== */
.sr-item.sr-active{background:var(--al-red-bg)}
.sr-flash{animation:srFlash 1.6s ease-out}
@keyframes srFlash{0%,20%{box-shadow:0 0 0 3px rgba(204,31,23,.55)}100%{box-shadow:0 0 0 3px rgba(204,31,23,0)}}
</style>
<?php bh_favicon_tags(); ?>
</head>
<body>
...
<div id="toc-drawer" role="dialog" aria-label="Table of contents" aria-modal="true">
  ...
  <nav id="toc-drawer-nav" aria-label="Sections">
    ...
    <a href="#creatives" onclick="closeTOC()"><span class="toc-num">12</span>Sample Winning Creatives</a>
  ...
  <div class="card collapsible" id="toc-card">
    ...
    <div class="sec-body">
      ...
      <div class="toc-grid">
        ...
        <a class="toc-tile" href="#creatives" onclick="expandAndJump('creatives')"><span class="toc-tile-num">12</span><span class="toc-tile-label">Sample Winning Creatives</span></a>
...
<section id="creatives" aria-label="Sample Winning Creatives">
  <div class="card collapsible" id="creatives-card">
    <div class="sec-hdr" onclick="toggleSection('creatives-card')">
      <div class="sec-hdr-left"><span class="eyebrow">Section 12</span><h2>Sample Winning Creatives</h2></div>
      <button class="sec-toggle"><svg viewBox="0 0 24 24"><polyline points="18 15 12 9 6 15"/></svg></button>
    </div>
    <div class="sec-body">
      <p>This section is a working reference for what has actually <em>worked</em> in paid social for our brands — the ads that got past testing, scaled, and held their ROAS. The patterns below are universal across the Inventel portfolio (Wild Earth, SugarMD, Pizza Pack, Spark, Life Watch, and the rest). The ALINE creatives themselves live behind the link underneath so they stay current.</p>

      <div class="creative-intro" data-search="winning creatives patterns paid social ads universal patterns">
        <strong>Looking at all our winning ads across the portfolio, here's what they have in common:</strong>
        <ol class="pattern-list">
          <li>
            <span class="pat-title">📌 Lead with a Specific, Relatable Problem</span>
            Every winner hooks with a pain point the customer already feels — not a product feature. “My feet are killing me by 2pm.” “I don't hunt. I nap.” “Fridge fight again?” The customer sees themselves in the ad before they read the offer.
          </li>
          <li>
            <span class="pat-title">⭐ Social Proof is Front and Center</span>
            Top performers lean heavily on proof — real reviews, star ratings, customer testimonials, “trusted by thousands.” The ads don't ask people to trust the brand; they show that others already do.
          </li>
          <li>
            <span class="pat-title">📱 Native, Authentic-Looking Creative</span>
            Winners don't look like polished corporate ads. Low-production authenticity consistently outperforms high-gloss creative on social.
          </li>
          <li>
            <span class="pat-title">🎯 One Clear, Simple Message</span>
            Every winning ad communicates a single idea. Not “here are five reasons to buy” — just one. The losers across our accounts tend to try to say too much.
          </li>
          <li>
            <span class="pat-title">🔁 Contrast and “Switch” Framing</span>
            Multiple winners use a before/after or “what I switched to” structure, positioning the product as the smarter alternative to what people do now. It validates the customer's frustration before presenting the fix.
          </li>
          <li>
            <span class="pat-title">🐾 Emotion Over Logic</span>
            None of our winners are making a rational argument first — they're making an emotional one, then backing it with proof.
          </li>
        </ol>
        <div class="through-line">
          <p><strong>The through-line:</strong> Your winning ads find a customer who already has a problem, show them someone like them who solved it, and make the product feel like the obvious next step — not a hard sell.</p>
        </div>
      </div>

      <h3>ALINE — Top-Performing Examples</h3>
      <p style="font-size:13.5px;color:var(--al-muted);margin-top:6px">Use these as reference for the patterns above when briefing new ad concepts, briefing influencers, or judging variants in testing rounds.</p>
      <div class="creatives-link-card">
        <p>Our current winning ALINE ads are shared in the team's Google Chat space, alongside the rest of the Inventel portfolio, so they stay up to date. You'll need to be signed in to your Inventel Google account to open it.</p>
      ...
      <div class="team-callout creative" data-search="creative briefs patterns winning ads blueprints">
        <strong>🎨 Creative — Use these as briefs, not blueprints</strong>
        When briefing new variants, pull <em>the pattern</em> from a winner, not the visual. For ALINE, any ad that shows the insole should make the biomechanical claim the ad is actually talking about — don't imply support the model doesn't provide. Ship pattern matches, not visual copies.
      </div>
      <div class="team-callout marketing" data-search="marketing testing creative patterns underperform structure">
        <strong>📈 Marketing — Test against these</strong>
        When a new concept enters testing, hold it up against the patterns above before pushing it live. If it doesn't lead with a specific problem, doesn't include social proof, looks too produced for the platform, tries to say more than one thing, or argues from logic rather than emotion, it has a known structural reason to underperform. Fix the structure before spending the budget.
      </div>
      <div class="team-callout newhire" data-search="new hire creative review ads library patterns practice">
        <strong>👋 New Hire — Spend 30 minutes with these</strong>
        Before your first ad-review meeting, open the winning creatives link and try to name the pattern(s) each ad is hitting without scrolling back to the list. Then open ALINE's current Meta Ads Library and find one ad that's running well — name its pattern.
      </div>
    </div>
  </div>
</section>
  ...
  <div class="card collapsible" id="quiz-card" style="background:linear-gradient(135deg,var(--al-coral) 0%,var(--al-red) 55%,var(--al-red-dk) 100%);border-color:transparent">
    ...
    <div class="sec-body" style="padding:20px 30px 40px">
      ...
      <div id="quiz-intro">
        ...
        <p style="color:rgba(255,255,255,.90);font-size:14px;max-width:660px">Read everything above first. You'll get a multiple-choice question one at a time, drawn from the whole hub. Select an answer and you'll see immediately whether you got it right, then click Next to continue. <strong style="color:#fff">Pass: 25 of 35 correct (70%).</strong> Retake as many times as you need — no penalty.</p>
        <p style="color:rgba(255,255,255,.90);font-size:14px;max-width:660px">When you pass, enter your name and title, then capture your result — a <strong style="color:#fff">screenshot of your score card is the easiest option</strong>, or you can print or save the certificate. <strong style="color:#fff">Every quiz — this one and every brand or platform quiz — follows the same submission process:</strong></p>
        ...
        <div class="naming-box">
          ...
          <span style="font-size:13px">Example for this hub: <code>Jane Doe_CX_ALINE_Quiz_092026.pdf</code></span>
        </div>
...
const PASS_THRESHOLD = Math.ceil(quizQuestions.length * 0.7); // 70% → 25/35
...
/* ===== SECTION COLLAPSE + TOC NAVIGATION ===== */
...
function expandSection(sectionId){
  ...
  if(!sec) return null;
  const card = sec.querySelector('.card.collapsible');
  if(card) card.classList.remove('collapsed');
  return sec;
}
function expandAndJump(sectionId){
  const sec = expandSection(sectionId);
  if(!sec) return;
  const navH = parseInt(getComputedStyle(document.documentElement)
                .getPropertyValue('--nav-h'), 10) || 60;
  requestAnimationFrame(() => {
    window.scrollTo({
      top: sec.getBoundingClientRect().top + window.pageYOffset - navH - 12,
      behavior: 'smooth'
    });
  });
}
/* ===== TOC DRAWER ===== */
function openTOC(){
  const d=document.getElementById('toc-drawer'), o=document.getElementById('toc-overlay');
...
/* Open the target section when arriving via a #hash link */
window.addEventListener('DOMContentLoaded', () => {
  if(location.hash.length > 1) expandAndJump(location.hash.slice(1));
});
...
/* ===================================================================
   HUB SEARCH
   Builds an index from the live DOM so it stays in sync with content.
   Renders to the markup ALINE's stylesheet already defines:
   .sr-group-label / .sr-item / .sr-item-icon / .sr-item-text / .sr-item-badge
   =================================================================== */
let searchIndex = [];
let srHits = [];
let srActive = -1;
...
/* Labels already carry a leading emoji; the group icon supplies it instead. */
function srStripIcon(t){
  return t.replace(/^(?:\p{Extended_Pictographic}|\uFE0F|\u200D|\s)+/u, '').trim() || t;
}

/* Give an element a stable id so results can scroll back to it. */
let srAutoId = 0;
function srEnsureId(el, prefix){
  if(!el.id) el.id = prefix + '-sr' + (++srAutoId);
  return el.id;
}

function srSectionOf(el){
...
function buildSearchIndex(){
  ...
  document.querySelectorAll('section[id]').forEach(sec => {
    if(sec.id === 'toc-section') return;
    const h2 = sec.querySelector('h2');
    if(!h2) return;
    searchIndex.push({
      group: 'Sections',
      label: srText(h2),
      badge: srText(sec.querySelector('.eyebrow')),
      targetId: sec.id,
      sectionId: sec.id,
      hay: (srText(h2) + ' ' + srText(sec.querySelector('.eyebrow')) + ' ' +
            sec.id.replace(/-/g, ' ') + ' ' + (sec.getAttribute('aria-label') || '')
           ).toLowerCase()
    });
  });
  ...
  /* 2 — Team callouts */
  const groupFor = el =>
      el.classList.contains('cx')        ? 'CX Callouts'
    : el.classList.contains('creative')  ? 'Creative Callouts'
    : el.classList.contains('marketing') ? 'Marketing Callouts'
    : el.classList.contains('brand')     ? 'Brand Callouts'
    : el.classList.contains('newhire')   ? 'New Hire Callouts'
    : 'Callouts';

  document.querySelectorAll('.team-callout').forEach(el => {
    const strong = el.querySelector('strong');
    if(!strong) return;
    const body = srText(el).slice(0, 400);
    const sid  = srSectionOf(el);
    searchIndex.push({
      group: groupFor(el),
      label: srStripIcon(srText(strong)),
      badge: sid ? srText(document.querySelector('#' + sid + ' h2')) : '',
      targetId: srEnsureId(el, 'callout'),
      sectionId: sid,
      hay: (srText(strong) + ' ' + body + ' ' + (el.dataset.search || '')).toLowerCase()
    });
  });

  /* 3 — Glossary terms */
  document.querySelectorAll('.gloss-item').forEach(el => {
    const term = el.querySelector('.gloss-term');
    if(!term) return;
    searchIndex.push({
      group: 'Glossary',
      label: srStripIcon(srText(term)),
      badge: srText(el.querySelector('.gloss-def')).slice(0, 60),
      targetId: srEnsureId(el, 'gloss'),
      sectionId: srSectionOf(el),
      hay: (srText(term) + ' ' + srText(el.querySelector('.gloss-def')) + ' ' +
            (el.dataset.search || '')).toLowerCase()
    });
  });
  ...
  document.querySelectorAll('.faq-item').forEach(el => {
    ...
    searchIndex.push({
      group: 'FAQs',
      label: srText(q).replace(/\s*\+\s*$/, ''),
      badge: '',
      targetId: srEnsureId(el, 'faq'),
      sectionId: srSectionOf(el),
      hay: (srText(q) + ' ' + srText(el.querySelector('.faq-a')) + ' ' +
            (el.dataset.search || '')).toLowerCase()
    });
  });
}
...
function srHighlight(text, q){
  const safe = srEscape(text);
  if(!q) return safe;
  const i = safe.toLowerCase().indexOf(q.toLowerCase());
  if(i < 0) return safe;
  return safe.slice(0, i) + '<mark>' + safe.slice(i, i + q.length) +
         '</mark>' + safe.slice(i + q.length);
}
...
function runSearch(raw){
  ...
  /* score: label match beats body match, earlier match beats later */
  srHits = searchIndex
    .map(e => {
      const li = e.label.toLowerCase().indexOf(q);
      const hi = e.hay.indexOf(q);
      if(li < 0 && hi < 0) return null;
      return { e, score: (li >= 0 ? 0 : 500) + (li >= 0 ? li : hi) };
    })
    .filter(Boolean)
  ...
  /* keep each group contiguous, ordered by its best hit */
  const rank = new Map();
  srHits.forEach((e, i) => { if(!rank.has(e.group)) rank.set(e.group, i); });
  srHits.sort((a, b) => rank.get(a.group) - rank.get(b.group));

  if(!srHits.length){
    box.innerHTML = '<div class="sr-group-label">No matches</div>';
  ...
  srHits.forEach(e => {
    if(e.group !== lastGroup){
      html += '<div class="sr-group-label">' + srEscape(e.group) + '</div>';
      lastGroup = e.group;
    }
    html += '<div class="sr-item" role="option" data-idx="' + idx + '" ' +
            'data-target="' + e.targetId + '" data-section="' + (e.sectionId || '') + '">' +
            '<span class="sr-item-icon">' + (SR_ICON[e.group] || '•') + '</span>' +
            '<span class="sr-item-text">' + srHighlight(e.label, q) + '</span>' +
            (e.badge ? '<span class="sr-item-badge">' + srEscape(e.badge) + '</span>' : '') +
            '</div>';
    idx++;
  });
  box.innerHTML = html;
  ...
  box.querySelectorAll('.sr-item').forEach(item => {
    item.addEventListener('click', () => srGoTo(item));
  });
}
...
function srGoTo(item){
  ...
  requestAnimationFrame(() => {
    ...
    const navH = parseInt(getComputedStyle(document.documentElement)
                  .getPropertyValue('--nav-h'), 10) || 60;
    window.scrollTo({
      top: el.getBoundingClientRect().top + window.pageYOffset - navH - 16,
      behavior: 'smooth'
    });
    el.classList.add('sr-flash');
    setTimeout(() => el.classList.remove('sr-flash'), 1600);
  });
}
...
function srMove(delta){
  ...
  if(srActive >= 0 && items[srActive]) items[srActive].classList.remove('sr-active');
  srActive = (srActive + delta + items.length) % items.length;
  items[srActive].classList.add('sr-active');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  input.addEventListener('keydown', e => {
    if(e.key === 'ArrowDown'){ e.preventDefault(); srMove(1); }
      ...
      const items = document.querySelectorAll('#search-results .sr-item');
      if(srActive >= 0 && items[srActive]){ e.preventDefault(); srGoTo(items[srActive]); }
      else if(items.length){ e.preventDefault(); srGoTo(items[0]); }
    }
    else if(e.key === 'Escape'){ closeSearch(); input.blur(); }
  });

  /* "/" focuses the search box, per the placeholder hint */
