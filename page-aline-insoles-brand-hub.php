...
<div id="toc-drawer" role="dialog" aria-label="Table of contents" aria-modal="true">
  ...
  <nav id="toc-drawer-nav" aria-label="Sections">
    ...
    <a href="#quiz-section" onclick="closeTOC()"><span class="toc-num">26</span>Knowledge Check Quiz</a>
  </nav>
</div>
  ...
  <div class="card collapsible" id="toc-card">
    ...
    <div class="sec-body">
      ...
      <div class="toc-grid">
        ...
        <a class="toc-tile" href="#quiz-section" onclick="expandAndJump('quiz-section')"><span class="toc-tile-num">26</span><span class="toc-tile-label">Knowledge Check Quiz</span></a>
      </div>
    </div>
  </div>
</section>
...
<section id="product-line" aria-label="Product Line">
  ...
  <table class="prod-card-table"><tr><th style="width:35%">Feature</th><th>Detail</th></tr><tr><td>Unique Feature</td><td>Heat-reflective top sheet — reflects body heat back into the foot for warmth</td></tr><tr><td>Comfort Layer</td><td>Memory foam for superior cushioning over long cold days outdoors</td></tr><tr><td>Heel Cup</td><td>Cushioned gel-pad heel cup; shock absorption in cold, hard conditions</td></tr><tr><td>Best Activities</td><td>Skiing, snowboarding, cold-weather cycling, winter hiking, hunting, outdoor work</td></tr><tr><td>Shipping Note</td><td>Continental US only — escalate AK/HI/international to CX Fulfillment Supervisor</td></tr></table>
      ...
      <!-- Replacement cadence -->
      <h3 style="margin-top:28px">Replacement Cadence</h3>
      <p style="font-size:14px">ALINE insoles are a <strong>one-time purchase</strong>. Alignment structures degrade with use, so most customers replace their insoles every <strong>6–12 months</strong> depending on wear frequency and activity level. There is no subscription or auto-replacement program — customers reorder manually at <a href="https://alineinsoles.com" target="_blank" rel="noopener">alineinsoles.com</a>.</p>
      <div class="team-callout cx" data-search="subscription discontinued one-time purchase reorder replacement insoles">
        <strong>📞 CX — No Subscription Program</strong>
        ALINE does <strong>not</strong> offer a subscription or auto-replacement plan. If a customer asks about one, let them know all orders are one-time purchases and they're welcome to reorder whenever they're ready. If a customer references an <em>existing</em> legacy recurring order, escalate to the CX Fulfillment Supervisor rather than attempting to modify it yourself.
      </div>
    ...
    <div class="sec-body">
      ...
      <div class="pillars">
        ...
        <div class="pillar">
          ...
          <p>Four models for different activities. TABs Kit for custom tilt. Size by arch, not shoe size. ALINE recognises that no two feet — and no two lives — are identical.</p>
        </div>
        <div class="pillar">
          <span class="pillar-icon">💪</span>
    ...
    <div class="sec-body">
      ...
      <div class="personas">
        ...
        <div class="persona" data-search="persona working professional nurse retail hospitality on feet all day">
          ...
          <div class="persona-desc">ER nurse. On her feet for 12-hour shifts on hard hospital floors. Foot and lower back pain are occupational hazards she's just accepted. A colleague showed her ALINE — she was initially sceptical of a "TV insole" but the science sold her. Now reorders the Cushion model roughly every 8 months.</div>
          <div class="persona-focus"><strong>Primary Pain:</strong> Foot fatigue, lower back pain, heel pain after long shifts<br><strong>Best Fit:</strong> Cushion Insoles; multi-pair purchase for work and off-hours shoes<br><strong>Message Angle:</strong> Trusted Advisor tone; science-backed, practical, cost-per-day value over a 6–12 month lifespan.</div>
        </div>
...
<section id="objections" aria-label="Objection Handling and Battlecards">
  <div class="card collapsible" id="objections-card">
    ...
    <div class="sec-body">
      ...
      <div class="objection" data-search="subscription cancel worried locked in one-time purchase no subscription">
        <div class="obj-q">"I don't want to be locked into a subscription."</div>
        <div class="obj-a">Good news — there isn't one. Every ALINE order is a straightforward one-time purchase. There's no subscription, no auto-replacement, no recurring billing, and nothing to cancel later. Most customers replace their insoles every 6–12 months as the alignment structures wear down, but that's entirely on your schedule — you just reorder whenever you're ready.</div>
      </div>
  ...
  <div class="card collapsible" id="customer-journey-card">
    ...
    <div class="sec-body">
        ...
        <table class="journey-table" style="min-width:780px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Guarantee visible at checkout; multi-pair upsell framed as "one pair per shoe"; frictionless checkout; order confirmation email</td>
            ...
            <tr>
              ...
              <td>Email (replacement reminders, multi-pair discount), paid retargeting, Shopify account portal</td>
              <td>Reorder reminder prompts; cross-sell to second model for a different shoe; seasonal campaigns (Climate in fall/winter); multi-pair discount messaging</td>
              <td>Send replacement reminder outreach at ~8 months; cross-sell second model on service contacts; confirm arch sizing on reorders</td>
            </tr>
            <tr>
      ...
      <table>
        ...
        <tr><td>Repeat purchase rate</td><td>Marketing / Growth</td><td>ALINE's 6–12 month replacement cycle makes reorder rate the key LTV driver</td></tr>
  ...
  <div class="card collapsible" id="marketing-angles-card">
    ...
    <div class="sec-body">
      ...
      <div class="angle-grid">
        ...
        <div class="angle" data-search="marketing angle replacement reorder 6 months renewal retention">
          <div class="angle-icon">🔁</div>
          <h4>Angle 5 — The Replacement Reminder</h4>
          <p>Insoles wear out — and most people don't notice until their feet start hurting again. ALINE's alignment structures degrade over 6–12 months of use. A well-timed reorder reminder catches customers right as the benefit starts to fade, before they write the product off as "stopped working."</p>
    ...
    <div class="sec-body">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td><strong>Multi-Pair Discount</strong></td><td>Standing discount when buying more than one pair</td><td>Depends — check sheet</td></tr>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>New customer (evergreen)</td><td>Marketing / Growth</td><td>Always active unless sheet flags otherwise</td></tr>
        </tbody>
      </table>
    </div>
  </div>
  ...
  <div class="card collapsible" id="glossary-card">
    ...
    <div class="sec-body">
      <div class="glossary-grid">
        <div class="gloss-item gloss-evergreen" data-search="glossary evergreen offer discount always on new customer">
          <div class="gloss-term">⭐ Evergreen Offer</div>
          <div class="gloss-def">A discount always live — not tied to a calendar event. For ALINE the primary evergreen offer is the <strong>New Customer first-order discount</strong>. (ALINE has no subscription program, so there is no Subscribe &amp; Save equivalent.) Assume active unless the monthly discount sheet flags otherwise.</div>
        </div>
        ...
        <div class="gloss-item" data-search="glossary replacement cycle reorder 6 12 months one-time purchase">
          <div class="gloss-term">Replacement Cycle</div>
          <div class="gloss-def">The 6–12 month window over which alignment structures degrade with normal wear, after which a customer should reorder. ALINE sells one-time purchases only — there is no subscription or auto-replacement program.</div>
        </div>
    ...
    <div class="sec-body">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td><strong>Subscriptions</strong></td><td>ALINE has no subscription program — all orders are one-time. Escalate any legacy recurring order to CX Fulfillment Supervisor</td></tr>
  ...
  <div class="card collapsible" id="faq-card">
    ...
    <div class="sec-body">
      ...
      <div class="faq-item" onclick="toggleFAQ(this)" data-search="FAQ how long do insoles last replace lifespan">
        ...
        <div class="faq-a">Typically 6–12 months depending on wear frequency and activity. Once the alignment structures lose their rebound, it's time to replace them. ALINE does not offer auto-replacement — reorder at alineinsoles.com whenever you're ready.</div>
      </div>
      ...
      <div class="faq-item" onclick="toggleFAQ(this)" data-search="FAQ subscription recurring one-time purchase reorder">
        <div class="faq-q">Does ALINE offer a subscription or auto-replacement plan? <span class="faq-toggle">+</span></div>
        <div class="faq-a">No. Every ALINE order is a <strong>one-time purchase</strong> — there's no subscription, no recurring billing, and nothing to cancel. When your insoles wear out (typically 6–12 months), simply reorder at <a href="https://alineinsoles.com" target="_blank" rel="noopener">alineinsoles.com</a>. Order history is available anytime at <a href="https://alineinsoles.com/account" target="_blank" rel="noopener">alineinsoles.com/account</a>. Questions? support@alineinsoles.com or 1-888-316-5658.</div>
      </div>
  ...
  <div class="card collapsible" id="quiz-card" style="background:linear-gradient(135deg,var(--al-coral) 0%,var(--al-red) 55%,var(--al-red-dk) 100%);border-color:transparent">
    ...
    <div class="sec-body" style="padding:20px 30px 40px">
      ...
      <div id="quiz-intro">
        ...
        <p style="color:rgba(255,255,255,.85);max-width:640px;font-size:14px;margin-bottom:18px">When you pass, enter your name and title, then capture your result — <strong style="color:#fff">a screenshot of your score card is the easiest option</strong>, or you can print or save the certificate. <strong style="color:#fff">Every quiz — this one and every brand or platform quiz — follows the same submission process:</strong></p>

        <ol style="color:rgba(255,255,255,.85);max-width:640px;font-size:14px;line-height:1.75;margin:0 0 20px 20px;padding:0">
          <li style="margin-bottom:6px"><strong style="color:#fff">Capture your result</strong> — a screenshot of your score card is easiest, or save it as a PDF.</li>
          <li style="margin-bottom:6px"><strong style="color:#fff">Name the file</strong> using the standard convention (below) so it's easy to find and track.</li>
          <li style="margin-bottom:6px"><strong style="color:#fff">Upload it</strong> to the <a href="https://drive.google.com/drive/folders/19vsre-bLq4zDgwEAYGcSX22SpJ7hNvIM?usp=drive_link" target="_blank" rel="noopener" style="color:#F5C518;text-decoration:underline">InvenTel University Quiz Results</a> folder.</li>
        ...
        <div style="max-width:640px;margin:0 0 22px;padding:14px 18px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.22);border-radius:10px">
          <strong style="color:#fff;font-size:13px;display:block;margin-bottom:6px">📄 File naming convention</strong>
          <code style="color:#F5C518;font-size:12.5px;word-break:break-word;font-family:'DM Mono',monospace">FirstName LastName_Team_Brand (or Platform)_Quiz_MMYYYY.pdf</code>
          <div style="color:rgba(255,255,255,.82);font-size:12.5px;line-height:1.6;margin-top:8px">
            Example: <code style="color:#F5C518;font-size:12px;font-family:'DM Mono',monospace">Jane Doe_CX_ALINE_Quiz_072026.pdf</code><br>
            Use your own team (CX, HR, Paid Media, Creative…) and the brand or platform the quiz covers — for this hub that's <strong style="color:#fff">ALINE</strong>. <strong style="color:#fff">MMYYYY</strong> is the numeric month and year you passed, e.g. <strong style="color:#fff">072026</strong> for July 2026.
          </div>
        </div>
...
const quizQuestions=[
  ...
  {q:"When should a CX agent NOT immediately process a return for uncomfortable insoles?",options:["If insoles are more than 45 days old","If the customer has only worn them 1–3 days — coach them through break-in first","If the customer paid with PayPal","If purchased on sale"],correct:1,ref:"§20 Return Policy"},
  ...
  {q:"Where does a customer view their order history and account details?",options:["alineinsoles.com/cart","alineinsoles.com/account","alineinsoles.com/checkout","alineinsoles.com/collections"],correct:1,ref:"§23 Shopify Platform"},
  ...
  {q:"Which discount type is EVERGREEN — always active unless flagged otherwise?",options:["DRTV campaign code","Full-site flash sale","New Customer first-order discount","Email campaign promo code"],correct:2,ref:"§16 Discounts / §19 Glossary"},
  ...
  {q:"What does the Evergreen Offer mean for ALINE? (Most complete answer)",options:["Any code on the monthly discount sheet","The New Customer first-order discount — always live unless flagged","Only codes issued by CX","Only codes that don't expire"],correct:1,ref:"§19 Glossary — Evergreen Offer"},
  ...
  if(passed){
    el.innerHTML = `
      <div style="max-width:560px;margin:0 auto">
        ...
        <div style="margin:18px auto 0;max-width:600px;padding:18px 20px;background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.25);border-radius:10px;color:rgba(255,255,255,.88);font-size:13px;line-height:1.65;text-align:left">
          <strong style="color:#fff;display:block;font-size:14px;margin-bottom:10px;text-align:center">📨 How to submit your completed quiz</strong>

          <div style="margin-bottom:6px"><strong style="color:#fff">Step 1 — Save your result.</strong> Either use <strong>🖨️ Print Certificate</strong> above and choose <strong>"Save as PDF"</strong> in the print dialog, or take a <strong>screenshot</strong> of this results screen. Both are accepted.</div>

          <div style="margin-bottom:6px"><strong style="color:#fff">Step 2 — Rename the file</strong> using the naming convention below. Files that aren't named correctly can't be matched to your record.</div>

          <div style="margin-bottom:12px"><strong style="color:#fff">Step 3 — Upload it</strong> to the InvenTel University Quiz Results folder, then <strong>notify whoever assigned this quiz</strong> — your onboarding manager, the Performance Team, your Department Lead, Brand Lead, or Agency Lead.</div>

          <div style="text-align:center;margin:14px 0">
            <a href="https://drive.google.com/drive/folders/19vsre-bLq4zDgwEAYGcSX22SpJ7hNvIM?usp=drive_link" target="_blank" rel="noopener" style="display:inline-block;background:#F5C518;color:#111111;font-weight:700;font-size:13px;padding:11px 22px;border-radius:8px;text-decoration:none;font-family:'DM Mono',monospace;letter-spacing:.03em">📁 OPEN QUIZ RESULTS FOLDER →</a>
          </div>
          ...
          <div style="margin-top:12px;padding-top:12px;border-top:1px solid rgba(255,255,255,.25)">
            ...
            <code style="color:#F5C518;font-size:12.5px;word-break:break-word">FirstName LastName_Team_Brand (or Platform)_Quiz_MMYYYY.pdf</code><br>
            <span style="font-size:12px;display:block;margin-top:6px">
              <em>Example (PDF):</em> <code style="color:#F5C518;font-size:12px">Jane Doe_CX_ALINE_Quiz_072026.pdf</code><br>
              <em>Example (screenshot):</em> <code style="color:#F5C518;font-size:12px">Jane Doe_CX_ALINE_Quiz_072026.png</code>
            </span>
            <span style="font-size:12px;display:block;margin-top:8px;opacity:.85">Use your own team (CX, HR, Paid Media, Creative…) and the brand or platform the quiz covers — for this hub that's <strong>ALINE</strong>. <strong>MMYYYY</strong> is the numeric month and year you passed, e.g. <strong>072026</strong> for July 2026.</span>
          </div>
        </div>
      </div>`;
  } else {
...
function expandTo(el){
  let card = el.closest ? el.closest('.collapsible') : null;
  while(card){
    card.classList.remove('collapsed');
    const h = card.querySelector('.sec-hdr');
    if(h) h.setAttribute('aria-expanded','true');
    card = card.parentElement ? card.parentElement.closest('.collapsible') : null;
  }
}
...
/* Expand the target section synchronously, then let the browser's native
   anchor jump do the scrolling (section{scroll-margin-top:var(--nav-h)}
   already offsets for the sticky header). Doing our own scrollTo here fought
   the native hash jump and lost. */
function expandAndJump(secId){
  const sec = document.getElementById(secId);
  if(!sec) return true;
  const card = sec.querySelector('.collapsible') || sec.closest('.collapsible');
  if(card){
    card.classList.remove('collapsed');
    const h = card.querySelector('.sec-hdr');
    if(h) h.setAttribute('aria-expanded','true');
  }
  // Flash after the scroll settles so the highlight is visible on arrival.
  setTimeout(()=>flashTarget(sec), 420);
  return true;
}
...
function hl(text, q){
  ...
  try{ return escHtml(text).replace(new RegExp('('+escRe(q)+')','ig'),'<mark>$1</mark>'); }
...
function buildSearchIndex(){
  ...
  document.querySelectorAll('section[id]').forEach(sec=>{
    if(sec.id === 'hero' || sec.id === 'toc-section') return;
    const h2 = sec.querySelector('h2');
    if(!h2) return;
    const eyebrow = sec.querySelector('.eyebrow');
    const body = sec.querySelector('.sec-body') || sec;
    const heads = [...body.querySelectorAll('h3,h4')].map(h=>h.textContent).join(' ');
    const intros = [...body.querySelectorAll('p')].slice(0,3).map(p=>p.textContent).join(' ');
    const firstP = body.querySelector('p');
    idx.push({
      type:'section', icon:'📄', badge:'Section',
      title: clean(h2.textContent),
      snippet: clean(firstP ? firstP.textContent : '').slice(0,150),
      targetId: sec.id,
      text: clean(eyebrow?eyebrow.textContent:'' ) .toLowerCase()+' '+clean(h2.textContent+' '+heads+' '+intros).toLowerCase()
    });
  });

  // 2) Team callouts
  const coTypes = {
    cx:{badge:'CX', icon:'📞'}, creative:{badge:'Creative', icon:'🎨'},
    marketing:{badge:'Marketing', icon:'📢'}, brand:{badge:'Brand', icon:'🌿'},
    newhire:{badge:'New Hire', icon:'👋'}
  };
  document.querySelectorAll('.team-callout').forEach((co,i)=>{
    const team = Object.keys(coTypes).find(t=>co.classList.contains(t));
    if(!team) return;
    const sec = co.closest('section[id]');
    if(!sec) return;
    if(!co.id) co.id = 'callout-'+sec.id+'-'+i;
    const strong = co.querySelector('strong');
    let title = strong ? clean(strong.textContent) : '';
    let bodyText = clean(co.textContent);
    if(title) bodyText = bodyText.replace(title,'').trim();
    title = title.replace(/^[📞🎨📢🌿👋]\s*/,'').replace(/^(CX|Creative|Marketing|Brand|New Hire)\s*[—·\-–:]\s*/i,'').trim();
    if(!title) title = bodyText.slice(0,70);
    const secH2 = sec.querySelector('h2');
    idx.push({
      type:'callout-'+team, icon:coTypes[team].icon, badge:coTypes[team].badge+' Callout',
      title:title, snippet:bodyText.slice(0,150), targetId:co.id,
      text:(team+' '+coTypes[team].badge+' '+title+' '+bodyText+' '+(co.dataset.search||'')+' '+clean(secH2?secH2.textContent:'')).toLowerCase()
    });
  });

  // 3) Glossary
  document.querySelectorAll('.gloss-item').forEach((g,i)=>{
    if(!g.id) g.id = 'gloss-'+i;
    const term = g.querySelector('.gloss-term');
    const def  = g.querySelector('.gloss-def');
    if(!term) return;
    idx.push({
      type:'glossary', icon:'📖', badge:'Glossary',
      title:clean(term.textContent), snippet:clean(def?def.textContent:'').slice(0,150),
      targetId:g.id,
      text:(clean(term.textContent)+' '+clean(def?def.textContent:'')+' '+(g.dataset.search||'')).toLowerCase()
    });
  });

  // 4) FAQ
  document.querySelectorAll('.faq-item').forEach((f,i)=>{
    if(!f.id) f.id = 'faq-'+i;
    const q = f.querySelector('.faq-q');
    const a = f.querySelector('.faq-a');
    if(!q) return;
    const qText = clean(q.textContent).replace(/\s*\+\s*$/,'');
    idx.push({
      type:'faq', icon:'❓', badge:'FAQ',
      title:qText, snippet:clean(a?a.textContent:'').slice(0,150), targetId:f.id,
      text:(qText+' '+clean(a?a.textContent:'')+' '+(f.dataset.search||'')).toLowerCase()
    });
  });

  // 5) Objections
  document.querySelectorAll('.objection').forEach((o,i)=>{
    if(!o.id) o.id = 'objection-'+i;
    const q = o.querySelector('.obj-q');
    const a = o.querySelector('.obj-a');
    if(!q) return;
    idx.push({
      type:'objection', icon:'🛡️', badge:'Objection',
      title:clean(q.textContent), snippet:clean(a?a.textContent:'').slice(0,150), targetId:o.id,
      text:(clean(q.textContent)+' '+clean(a?a.textContent:'')+' '+(o.dataset.search||'')).toLowerCase()
    });
  });
...
function scoreHit(e, qLower, tokens){
  const t = e.title.toLowerCase();
  let s = 0;
  if(t === qLower) s += 1000;
  else if(t.startsWith(qLower)) s += 500;
  else if(t.includes(qLower)) s += 250;
  if(e.text.includes(qLower)) s += 50;
  tokens.forEach(tok=>{ if(t.includes(tok)) s += 40; });
  if(e.type === 'section') s += 30;
  return s;
}
...
function runSearch(q){
  ...
  q = q.trim();
  if(q.length < 2){ box.style.display='none'; searchHits=[]; searchActive=-1; return; }

  const qLower = q.toLowerCase();
  const tokens = qLower.split(/\s+/).filter(t=>t.length>=2);
  const useBoundary = qLower.length <= 3 && !/\s/.test(qLower);
  let wb = null;
  if(useBoundary){ try{ wb = new RegExp('\\b'+escRe(qLower)+'\\b','i'); }catch(e){} }

  const matches = e => {
    if(wb) return wb.test(e.text) || wb.test(e.title);
    if(e.text.includes(qLower)) return true;
    return tokens.length > 1 && tokens.every(t=>e.text.includes(t));
  };

  const hits = searchIndex.filter(matches)
    .map(e=>({e, s:scoreHit(e,qLower,tokens)}))
    .sort((a,b)=>b.s-a.s).slice(0,40).map(x=>x.e);

  searchActive = -1;

  if(!hits.length){
    searchHits = [];
    box.innerHTML = '<div style="padding:16px 14px;font-size:13px;color:#777;text-align:center">No matches for <strong>'+escHtml(q)+'</strong></div>';
    box.style.display='block';
    return;
  }

  const groups = [
    ['section','Sections'],['callout-cx','CX Callouts'],['callout-creative','Creative Callouts'],
    ['callout-marketing','Marketing Callouts'],['callout-brand','Brand Callouts'],
    ['callout-newhire','New Hire Callouts'],['glossary','Glossary'],['faq','FAQ'],['objection','Objections']
  ];
  const by = {};
  hits.forEach(h=>{ (by[h.type]=by[h.type]||[]).push(h); });
  ...
  groups.forEach(([key,label])=>{
    ...
    bucket.forEach(h=>{
      flat.push(h);
      html += '<div class="sr-item" data-idx="'+n+'" data-target="'+h.targetId+'">'
           +  '<span class="sr-item-icon">'+h.icon+'</span>'
           +  '<span class="sr-item-text"><strong>'+hl(h.title,q)+'</strong>'
           +  (h.snippet ? '<br><span style="font-size:12px;color:#777">'+hl(h.snippet,q)+'</span>' : '')
           +  '</span><span class="sr-item-badge">'+h.badge+'</span></div>';
      n++;
    });
  });
  searchHits = flat;
  ...
  box.querySelectorAll('.sr-item').forEach(item=>{
    item.addEventListener('click',()=>jumpToResult(item.getAttribute('data-target')));
  });
}

function jumpToResult(targetId){
  const el = document.getElementById(targetId);
  if(!el) return;
  closeSearch();
  expandTo(el);
  // Search results are plain divs (no href), so we scroll explicitly here.
  // Wait for the expand transition so we measure the final position.
  setTimeout(()=>{
...
function moveActive(delta){
  ...
  if(searchActive >= 0 && items[searchActive]) items[searchActive].style.background='';
  searchActive = (searchActive + delta + items.length) % items.length;
  items[searchActive].style.background = 'var(--al-red-bg)';
...
document.addEventListener('DOMContentLoaded',function(){
  ...
  if(input){
    let t = null;
    input.addEventListener('input',()=>{ clearTimeout(t); t=setTimeout(()=>runSearch(input.value),80); });
    ...
    input.addEventListener('keydown',e=>{
      if(e.key==='ArrowDown'){ e.preventDefault(); moveActive(1); }
        ...
        const items = document.querySelectorAll('#search-results .sr-item');
        if(searchActive>=0 && items[searchActive]){ e.preventDefault(); jumpToResult(items[searchActive].getAttribute('data-target')); }
        else if(items.length===1){ e.preventDefault(); jumpToResult(items[0].getAttribute('data-target')); }
      }
  ...
  // "/" focuses search · Esc closes drawer
  document.addEventListener('keydown',e=>{
    const tag = document.activeElement ? document.activeElement.tagName : '';
    if(e.key==='/' && tag!=='INPUT' && tag!=='TEXTAREA'){ e.preventDefault(); if(input) input.focus(); }
    if(e.key==='Escape'){ closeTOC(); }
  });

  // TOC drawer links: expand the target section synchronously (before the
  // native anchor jump) so the browser scrolls to its final, expanded height.
  document.querySelectorAll('#toc-drawer-nav a').forEach(a=>{
